...
public class App {
    public static void main(String[] args) throws PersonaGiaEsistenteException{

        HashMap<Integer,Integer> valori = new HashMap<>();
        ...
        if(valori.containsKey(numero)){
            //PersonaGiaEsistenteException
            throw new PersonaGiaEsistenteException("La mia prima eccezione");
        }
